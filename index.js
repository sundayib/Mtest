...
{ 
    ...
    if(TaskToHandle==1)
          ...
          { 
                    alert('Task is mobile ad');
          }   
  else if(TaskToHandle==3)
          { 
                    alert('Task is mobile YT');
          }   
          ...
          { 
                    alert('Task is empty '+TaskToHandle);
          }   
          }
          else
          {
             if(TaskToHandle==1)
          { alert(moviePage);//window.open(moviePage);
          }   
   else if(TaskToHandle==2)
          { 
 ...
 function ShowMovieList()
{
  ...
  document.getElementById("p3content").innerHTML= "  ";      
    ...
    {
   ini(lis[i].Tit,lis[i].Des,"VidImgs\\"+lis[i].Lid+".jpg",lis[i].Length,lis[i].HLink,lis[i].LLink,lis[i].HSize,lis[i].LSize,lis[i].Lid);
    }
    }
